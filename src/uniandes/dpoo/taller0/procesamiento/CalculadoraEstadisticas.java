...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta de que pais es un atleta determinado).
	 * @param atleta   El nombre del atleta de interés.
	 * @return Retorna un string con el nombre del pais al cual el atleta representa.
	 */
	public String PaisyAtleta(String atleta)
	{
		...
		if (elatleta != null) 
		{
			resultado1 = elatleta.darPais();
			resultado2 = resultado1.darNombre();
