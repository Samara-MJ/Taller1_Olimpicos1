...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el nombre del país al cual representa un atleta");
		System.out.println("14. Salir de la aplicación\n");
	}
	
	/**
	 * Le muestra al usuario nombre del país al cual representa un atleta.
	 */
	private void ejecutarPaisAtleta()
	{
		String atleta = input("Por favor ingrese el nombre de un atleta");
		String pais = calculadora.PaisyAtleta(atleta);
		if (pais == null) 
		{
			System.out.println("No hay registros para el atleta ingresado");
			}
		else 
		{
			System.out.println("\n" + "El pais al que pertenece el atleta " + atleta + " es: " + pais);
		}
